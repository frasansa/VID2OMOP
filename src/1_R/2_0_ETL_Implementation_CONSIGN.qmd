...
```{r}
# free up some memory--------------------------------------------------------
rm(sip, sip_periods, sip_periods_0, sip_periods_1, sip_periods_2,
...
concepts_vocabulary <- fread(file.path("vocabularies3", "CONCEPT.csv"))
concepts_relationship <- fread(file.path("vocabularies3", "CONCEPT_RELATIONSHIP.csv"))
concepts_ancestor <- fread(file.path("vocabularies3", "CONCEPT_ANCESTOR.csv"))
...
cdm_source <- tibble(
  ...
  cdm_release_date = ymd("2023-07-08"),
  cdm_version = "5.4",
