...
concepts_vocabulary <- fread(file.path("..", "EHDEN",  "Vocabularies2", 
                                       "CONCEPT.csv"))
concepts_relationship <- fread(file.path("..", "EHDEN",  "Vocabularies2", 
                                         "CONCEPT_RELATIONSHIP.csv"))
concepts_ancestor <- fread(file.path("..", "EHDEN",  "Vocabularies2", 
