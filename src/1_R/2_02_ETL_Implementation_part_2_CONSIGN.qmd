...
from_drug_exposure_vid_0_to_drug_exposure <- drug_exposure_vid_0 |>
...
from_procedure_occurrence_vid_0_to_device_exposure <- procedure_occurrence_vid_0 |>
  ...
  arrange(procedure_occurrence_id) |> 
  transmute(
    device_exposure_id = 1:n() + last_drug_exposure_vid_0_device_id,
    person_id = person_id,
...
source_to_concept_map_vid |> distinct(source_vocabulary_id)
